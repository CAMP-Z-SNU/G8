...
<meta name="verify-admitad" content="fb09364f2b">
    ...
    <link rel="stylesheet" href="./4_9_24_files/bootstrap.min.css">

    
    <link rel="stylesheet" href="./4_9_24_files/onlinegdb.css">
    
    
    <script async="" src="./4_9_24_files/gtm.js.download"></script><script>  var main_ide =  true;  </script>
    
    
    <script type="text/javascript" src="./4_9_24_files/onlinegdb.js.download"></script><style type="text/css">  .JColResizer{table-layout:fixed;} .JColResizer > tbody > tr > td, .JColResizer > tbody > tr > th{overflow:hidden}  .JPadding > tbody > tr > td, .JPadding > tbody > tr > th{/*padding-left:0!important; */padding-right:0!important;} .JCLRgrips{ height:0px; position:relative;} .JCLRgrip{margin-left:-5px; position:absolute; z-index:5; } .JCLRgrip .JColResizer{position:absolute;background-color:red;filter:alpha(opacity=1);opacity:0;width:10px;height:100%;cursor: col-resize;top:0px} .JCLRLastGrip{position:absolute; width:1px; } .JCLRgripDrag{ border-left:1px dotted black;	} .JCLRFlex{width:auto!important;} .JCLRgrip.JCLRdisabledGrip .JColResizer{cursor:default; display:none;}</style>
    <script type="text/javascript" src="./4_9_24_files/ace.js.download"></script>
    <script type="text/javascript" src="./4_9_24_files/ext-language_tools.js.download"></script>
    <script type="text/javascript" src="./4_9_24_files/editor.js.download" defer=""></script>
    <script type="text/javascript" src="./4_9_24_files/main.js.download" defer=""></script>
    

    <link rel="stylesheet" href="./4_9_24_files/bootstrap-select.min.css">
    <script src="./4_9_24_files/bootstrap-select.min.js.download"></script>
    ...
    </script><script type="text/javascript" async="" src="./4_9_24_files/onlinegdb(1).js.download"></script>
    <script type="text/javascript" src="./4_9_24_files/monetization.js.download"></script>
...
-->
<script src="./4_9_24_files/theme-idle_fingers.js.download"></script><script src="./4_9_24_files/mode-c_cpp.js.download"></script><script src="./4_9_24_files/c_cpp.js.download"></script></head>
...
<center>
    ...
    <script async="" type="text/javascript" src="./4_9_24_files/carbon.js.download" id="_carbonads_js"></script> 
...
<span style="float:none;clear:both">© 2016 - 2024 GDB Online</span>
    ...
    <div class="split-pane-component" id="right-component">
        ...
        <script src="./4_9_24_files/js-dos.js.download"></script>
...
<!--                  <option  value="c++11">C++ 11</option> -->
    ...
    <div class="editor_text_panes tab-content clearfix">
        ...
        <div id="editor_1" data-format="S" data-readonly-ranges="" class="tab-pane active editor ace_editor ace-idle-fingers ace_dark" style="font-size: medium;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; top: 260px; left: 64px;"></textarea><div class="ace_gutter" aria-hidden="true" style="left: 0px; width: 51px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; top: 0px; left: 0px; width: 51px;"><div class="ace_gutter-cell " style="height: 20px; top: 0px;">1<span style="display: none; height: 18px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 20px; top: 20px;">2<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 20px; top: 40px;">3<span style="display: inline-block; height: 20px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 20px; top: 60px;">4<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 20px; top: 80px;">5<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 20px; top: 100px;">6<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 20px; top: 120px;">7<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 20px; top: 140px;">8<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 20px; top: 160px;">9<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 20px; top: 180px;">10<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 20px; top: 200px;">11<span style="display: none; height: 18px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 20px; top: 220px;">12<span style="display: none; height: 18px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell ace_gutter-active-line " style="height: 20px; top: 240px;">13<span style="display: none; height: 18px;" class="ace_fold-widget ace_start ace_open"></span></div></div></div><div class="ace_scroller" style="line-height: 20px; left: 51px; right: 0px; bottom: 0px;"><div class="ace_content" style="top: 0px; left: 0px; width: 1314px; height: 573px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 708px; visibility: visible;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height: 20px; top: 240px; left: 0px; right: 0px;"></div><div class="ace_bracket ace_start ace_br15" style="height: 20px; width: 8.79688px; top: 240px; left: 4px;"></div><div class="ace_bracket ace_start ace_br15" style="height: 20px; width: 8.79688px; top: 40px; left: 100.766px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; top: 0px; left: 0px;"><div class="ace_line" style="height: 20px; top: 0px;"><span class="ace_keyword">#include</span><span class="ace_constant ace_other"> &lt;stdio.h&gt;</span></div><div class="ace_line" style="height: 20px; top: 20px;"></div><div class="ace_line" style="height: 20px; top: 40px;"><span class="ace_storage ace_type">int</span> <span class="ace_identifier">main</span><span class="ace_paren ace_lparen">(</span><span class="ace_paren ace_rparen">)</span> <span class="ace_paren ace_lparen">{</span></div><div class="ace_line" style="height: 20px; top: 60px;">    <span class="ace_storage ace_type">float</span> <span class="ace_identifier">a</span><span class="ace_punctuation ace_operator">,</span><span class="ace_identifier">b</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 20px; top: 80px;">    </div><div class="ace_line" style="height: 20px; top: 100px;">    <span class="ace_support ace_function ace_C99 ace_c">printf</span><span class="ace_paren ace_lparen">(</span><span class="ace_string ace_start">"</span><span class="ace_string">ENTER A NUMBER:</span><span class="ace_string ace_end">"</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 20px; top: 120px;">    <span class="ace_support ace_function ace_C99 ace_c">scanf</span><span class="ace_paren ace_lparen">(</span><span class="ace_string ace_start">"</span><span class="ace_constant ace_language ace_escape">%f%f</span><span class="ace_string ace_end">"</span><span class="ace_punctuation ace_operator">,</span><span class="ace_keyword ace_operator">&amp;</span><span class="ace_identifier">a</span><span class="ace_punctuation ace_operator">,</span><span class="ace_keyword ace_operator">&amp;</span><span class="ace_identifier">b</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 20px; top: 140px;">    <span class="ace_support ace_function ace_C99 ace_c">printf</span><span class="ace_paren ace_lparen">(</span><span class="ace_string ace_start">"</span><span class="ace_string">sum is:</span><span class="ace_constant ace_language ace_escape">%f\n</span><span class="ace_string ace_end">"</span><span class="ace_punctuation ace_operator">,</span><span class="ace_identifier">a</span><span class="ace_keyword ace_operator">+</span><span class="ace_identifier">b</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 20px; top: 160px;">    <span class="ace_support ace_function ace_C99 ace_c">printf</span><span class="ace_paren ace_lparen">(</span><span class="ace_string ace_start">"</span><span class="ace_string">subtraction of 2 numbers is:</span><span class="ace_constant ace_language ace_escape">%f\n</span><span class="ace_string ace_end">"</span><span class="ace_punctuation ace_operator">,</span><span class="ace_identifier">a</span><span class="ace_keyword ace_operator">-</span><span class="ace_identifier">b</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 20px; top: 180px;">    <span class="ace_support ace_function ace_C99 ace_c">printf</span><span class="ace_paren ace_lparen">(</span><span class="ace_string ace_start">"</span><span class="ace_string">multiplication of 2 numbers is:</span><span class="ace_constant ace_language ace_escape">%f\n</span><span class="ace_string ace_end">"</span><span class="ace_punctuation ace_operator">,</span><span class="ace_identifier">a</span><span class="ace_keyword ace_operator">*</span><span class="ace_identifier">b</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 20px; top: 200px;">    <span class="ace_support ace_function ace_C99 ace_c">printf</span><span class="ace_paren ace_lparen">(</span><span class="ace_string ace_start">"</span><span class="ace_string">ratio of 2 numbers is </span><span class="ace_constant ace_language ace_escape">%f\n</span><span class="ace_string ace_end">"</span><span class="ace_punctuation ace_operator">,</span><span class="ace_identifier">a</span><span class="ace_keyword ace_operator">/</span><span class="ace_identifier">b</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 20px; top: 220px;">    <span class="ace_keyword ace_control">return</span> <span class="ace_constant ace_numeric">0</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 20px; top: 240px;"><span class="ace_paren ace_rparen">}</span></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor" style="display: block; top: 240px; left: 13px; width: 9px; height: 20px; animation-duration: 1000ms;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="display: none; width: 22px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 22px; height: 260px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 22px; left: 51px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 22px; width: 1314px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; font-optical-sizing: inherit; font-size-adjust: inherit; font-kerning: inherit; font-feature-settings: inherit; font-variation-settings: inherit; overflow: visible;"></div></div></div>
        
    </div>
    <div id="sidebar_adunit_wrapper">
        <div class="col-sm-12 text-right" style="padding-bottom: 10px;">
        <a href="https://www.onlinegdb.com/online_c_compiler#" onclick="hide_sidebar_adunit_wrapper();" style="color:white;"> close ad [x]</a></div>
...
<style>
    ...
    <div id="console-fadder" style="display: none;">
        <center><img src="./4_9_24_files/loading.gif"><img>
    ...
    <div id="console-content" class="tab-content">
        <div id="tab-stdin" class="tab-pane fade in active">
            ...
            <div id="interactive-terminal-container" style="position:absolute; margin:0px;top:0px; bottom:0px; left:0px; right:0px;" class="col-sm-121"><div dir="ltr" class="terminal xterm" tabindex="0" role="document"><div class="xterm-viewport" style="background-color: rgb(0, 0, 0);"><div class="xterm-scroll-area" style="height: 178px;"></div></div><div class="xterm-screen" style="width: 1342px; height: 160px;"><div class="xterm-helpers"><textarea class="xterm-helper-textarea" aria-label="Terminal input" aria-multiline="false" autocorrect="off" autocapitalize="off" spellcheck="false" tabindex="0" style="left: 252.35px; top: 126px; width: 9.0125px; height: 18px; line-height: 18px; z-index: -5;"></textarea><span class="xterm-char-measure-element" aria-hidden="true" style="font-family: courier-new, courier, monospace; font-size: 15px;">W</span><div class="composition-view"></div></div><canvas class="xterm-text-layer" style="z-index: 0; width: 1342px; height: 160px;" width="1510" height="180"></canvas><canvas class="xterm-selection-layer" style="z-index: 1; width: 1342px; height: 160px;" width="1510" height="180"></canvas><canvas class="xterm-link-layer" style="z-index: 2; width: 1342px; height: 160px;" width="1510" height="180"></canvas><canvas class="xterm-cursor-layer" style="z-index: 3; width: 1342px; height: 160px;" width="1510" height="180"></canvas></div></div></div>
  ...
  <div class="panel panel-default">
    ...
    <div id="debug_window_call_stack" class="collapse in">
        <div class="table-responsive"><div class="JCLRgrips" style="width: 156.222px;"><div class="JCLRgrip" style="left: 1.44446px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip" style="left: 1.44446px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip JCLRLastGrip" style="left: 1.44446px; height: 25px;"></div></div><table class="table table-bordered JPadding JColResizer" id="JColResizer1">
  ...
  <div class="panel panel-default">
    ...
    <div id="debug_window_local_variables" class="collapse in">
        <div class="table-responsive"><div class="JCLRgrips" style="width: 112.222px;"><div class="JCLRgrip" style="left: 1.44446px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip JCLRLastGrip" style="left: 1.44446px; height: 25px;"></div></div><table class="table table-bordered JPadding JColResizer" id="JColResizer2">
...
<div class="panel panel-default panel-display-expression">
    ...
    <div class="table-responsive">
        <div class="JCLRgrips" style="width: 146.222px;"><div class="JCLRgrip" style="left: 1.44446px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip" style="left: 1.44446px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip JCLRLastGrip" style="left: 1.44446px; height: 25px;"></div></div><table class="table table-bordered JPadding JColResizer" style="margin-bottom:0px" id="JColResizer0">
...
<div class="panel panel-default">
    ...
    <div id="debug_window_breakpoints" class="collapse in">
        <div class="table-responsive"><div class="JCLRgrips" style="width: 139.222px;"><div class="JCLRgrip" style="left: 1.44446px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip" style="left: 1.44446px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip" style="left: 1.44446px; height: 25px;"><div class="JColResizer"></div></div><div class="JCLRgrip JCLRLastGrip" style="left: 1.44446px; height: 25px;"></div></div><table class="table table-bordered JPadding JColResizer" id="JColResizer3">
...
<script async="" src="./4_9_24_files/js"></script>
<script>
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'8bdf1b00fe852bf3',t:'MTcyNTQ2NDcxNC4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script><iframe height="1" width="1" style="position: absolute; top: 0px; left: 0px; border: none; visibility: hidden;" src="./4_9_24_files/saved_resource.html"></iframe>
